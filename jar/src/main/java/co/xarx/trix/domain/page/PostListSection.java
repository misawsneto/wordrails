...
public class PostListSection extends BaseSection implements QueryableSection<ElasticSearchQuery> {
	...
	@Override
	public List<Block> getBlocks(QueryExecutor executor) {
		return query.getResults(executor);
	}
