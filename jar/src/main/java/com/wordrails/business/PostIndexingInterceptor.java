...
public class PostIndexingInterceptor implements EntityIndexingInterceptor {

	private static final Logger log = LoggerFactory.getLogger(PostIndexingInterceptor.class);
