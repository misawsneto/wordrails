...
public interface AuthCredentialsApi {
	@PUT
	@Path("/")
	void updateAuthCredentials(AuthCredentialDto authCredential) throws ServletException, IOException;

	@GET
	@Path("/")
	AuthCredential getAuthCredentials() throws ServletException, IOException;
