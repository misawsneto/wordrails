          ...
          $stateProvider
              .state('app', {
                  ...
                  resolve: {
                      deps: ['$ocLazyLoad',
                      function( $ocLazyLoad ){
                          return $ocLazyLoad.load(['720kb.socialshare', 'videosharing-embed', 'toaster', 'afkl.lazyImage', 'angularRipple', 'infinite-scroll','../bower_components/livestamp/livestamp.min.js?' + GLOBAL_URL_HASH]).then(function(){
              ...
              .state('app.stations', {
                  ...
                  resolve: {
                      deps: ['$ocLazyLoad',
                      function( $ocLazyLoad ){
                          return $ocLazyLoad.load(['ui.slimscroll', 'angular-carousel', 'slick', 'js/controllers/stations.js?' + GLOBAL_URL_HASH]);
                      }]
                  },
