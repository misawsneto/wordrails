    ...
    $.fn.pgwSlider = function(options) {
        ...
        var setup = function() {
            ...
            pgwSlider.plugin.find('.ps-list > li').each(function() {
                ...
                if (element.image) {
                    currentElement.html('<img class="opacity-0" src="' + element.image + '" alt="' + (element.title ? element.title : '') + '">' + 
                        '<div style="background-image: url('+ element.image +')" class="md-whiteframe-z1 pos-abt top-0 bottom-0 right-0 left-0 bg-cover"></div>');
                } else if (element.thumbnail) {
                    currentElement.html('<img class="opacity-0" src="' + element.thumbnail + '" alt="' + (element.title ? element.title : '') + '">' + 
                        '<div style="background-image: url('+ element.thumbnail +')" class="md-whiteframe-z1 pos-abt top-0 bottom-0 right-0 left-0 bg-cover"></div>');
                }
