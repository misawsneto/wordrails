...
<body ng-controller="AppCtrl" ng-cloak>
  ...
  <script src="${pageContext.request.contextPath}/bower_components/angular-aria/angular-aria.js"></script>
  <script src="${pageContext.request.contextPath}/bower_components/angular-cookies/angular-cookies.js"></script>
  <script src="${pageContext.request.contextPath}/bower_components/angular-messages/angular-messages.js"></script>
  <script src="${pageContext.request.contextPath}/bower_components/angular-resource/angular-resource.js"></script>
  <script src="${pageContext.request.contextPath}/bower_components/angular-sanitize/angular-sanitize.js"></script>
  <script src="${pageContext.request.contextPath}/bower_components/angular-touch/angular-touch.js"></script>
  <script src="${pageContext.request.contextPath}/bower_components/angular-material/angular-material.js"></script>
